class PositionBase < ActiveRecord::Base
  ...
  validates :trade_type_id, inclusion: { in: PositionBase.trade_types_ids }
  validates :option_id, inclusion: { in: PositionBase.options_ids }
  validates :weight_dimension_id, inclusion: { in: PositionBase.dimensions_ids }
  validates :price_weight_dimension_id, inclusion: { in: PositionBase.dimensions_ids }
